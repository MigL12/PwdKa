    ...
    const CompanyDashboard = () => {
      ...
      <button
        className="py-2 px-4 mb-0 rounded-lg bg-blue-600 text-white" // Removed margin-bottom to eliminate the space
                ...
                sortedApplicants.map((applicant) => (
                  ...
                  >
                    <div className="flex flex-col text-left">
                      ...
                      <p className="mb-2 text-xl bg-custom-bg rounded-md text-custom-blue">{applicant.fullName}</p>
      
                      <p className="font-semibold text-lg  text-white">Email:</p>
                      <p className="mb-2 text-xl bg-custom-bg rounded-md text-custom-blue">{applicant.email}</p>
      
                      <p className="font-semibold text-lg  text-white">Job Applied For:</p>
                      <p className="mb-2 text-xl bg-custom-bg rounded-md text-custom-blue">{applicant.jobAppliedFor}</p>
